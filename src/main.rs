...
fn read_csv_file(pg: &ProgressBar, path: &PathBuf) -> Result<Vec<AirdropEntry>> {
    pg.println("Reading the csv input...");
    pg.set_style(ProgressStyle::default_spinner());
